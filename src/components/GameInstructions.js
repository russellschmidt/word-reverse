...
export default () => (
  <div className="game-instructions__text">
    ...
    <p>We were impressed with your qualifications and are excited to work with you on an interim contract basis through a third party agency. Welcome to the team!</p>
